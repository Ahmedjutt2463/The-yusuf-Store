      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;">
        ...
        <tr><td style="padding:35px 40px 20px;">
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#faf6f0;border-radius:6px;padding:18px 20px;margin-bottom:24px;border:2px solid #e2b93b;">
            ...
            <tr><td style="font-size:13px;color:#8a7a6a;padding:8px 0 2px;border-top:1px solid #e8e0d0;">Device Model</td><td style="font-size:14px;color:#1a1a2e;font-weight:700;text-align:right;padding:8px 0 2px;">${esc((device && device.model) || '-')}</td></tr>
            <tr><td style="font-size:13px;color:#8a7a6a;padding:2px 0;">OS</td><td style="font-size:13px;color:#3a2a1a;text-align:right;padding:2px 0;">${esc((device && device.os) || '-')}${device && device.platformVersion ? ' (' + esc(device.platformVersion) + ')' : ''}</td></tr>
            <tr><td style="font-size:13px;color:#8a7a6a;padding:2px 0;">Browser</td><td style="font-size:13px;color:#3a2a1a;text-align:right;padding:2px 0;">${esc((device && device.browserName) || '-')}</td></tr>
            <tr><td style="font-size:13px;color:#8a7a6a;padding:2px 0;">Screen</td><td style="font-size:13px;color:#3a2a1a;text-align:right;padding:2px 0;">${esc((device && device.screen) || '-')}${device && device.architecture ? ' (' + esc(device.architecture) + ')' : ''}</td></tr>
            <tr><td style="font-size:13px;color:#8a7a6a;padding:2px 0;">Touchscreen</td><td style="font-size:13px;color:#3a2a1a;text-align:right;padding:2px 0;">${esc((device && device.touch) || '-')}</td></tr>
            <tr><td style="font-size:13px;color:#8a7a6a;padding:2px 0;">Memory / CPU</td><td style="font-size:13px;color:#3a2a1a;text-align:right;padding:2px 0;">${esc((device && device.memory) || '-')} / ${esc((device && device.cores) || '-')} cores</td></tr>
